    ...
    success: function (data) {
        $(data).find("a").attr("href", function (i, val) {
            if (val.match(/\.(jpe?g|png|gif)$/)) {
                directories.push(currentDir = new HoldDirectory(val));
...
var template = '<li><img src="${link}job-board.png"><li>';
var link = "https://draccarr.github.io/images/";
